...
import 'Sem7_Timeline_Screen.dart';
import 'Sem8_Timeline_Screen.dart';

// Declaring Constants
const DeepBlue = Color(0xff35548e);

// Main Widget For The Students.Timeline Page
    ...
    return Container(
      child: Column(
        children: [
          ...
          Text(
            "Events displayed in the Students.Timeline for Each Semester are to be "
                "Mandatory completed in order to receive the Completion Certificate.",
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 20.0,
              color: Colors.black,
          ...
          GestureDetector(
            ...
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => Sem7_TimeLine() ));
            },
          ),
          ...
          GestureDetector(
            ...
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => Sem8_TimeLine()));
            },
          ),
        ],
      ),
