...
// Main Widget Sem8 Students.Timeline
class Sem8_TimeLine extends StatelessWidget {
  @override
          ...
          TimelineTile(
            ...
            leftChild: GestureDetector(
              child: Container(
                child: Column(
                  children: [
                    Image.asset("assets/TimeLine_Images/Updating_mentor.png",height: 50.0,width: 50.0),
                    SizedBox(height: 5.0),
                    Text(
                      "Updating\nMentor",
              ...
              onTap: () {
                return showDialog(
                  ...
                  builder: (ctx) => AlertDialog(
                    ...
                    title: Text("Updating Mentor", textAlign: TextAlign.center),
          ...
          TimelineTile(
            ...
            rightChild: GestureDetector(
              child: Container(
                child: Column(
                  children: [
                    Image.asset("assets/TimeLine_Images/Progress_presentation.png", height: 50, width: 50,),
                    SizedBox(
                      height: 5,
                    ),
                    Text(
              ...
              onTap: () {
                return showDialog(
                  ...
                  builder: (ctx) => AlertDialog(
                    backgroundColor: BackGround_Colour,
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(15))),
                    title: Text("Progress Presentation", textAlign: TextAlign.center),
                    content: Text("Details for the Procedure"),
                    actions: <Widget>[
                      FlatButton(
                        onPressed: () {
          ...
          TimelineTile(
            ...
            leftChild: GestureDetector(
              child: Container(
                child: Column(
                  children: [
                    Image.asset("assets/TimeLine_Images/Weeklymeetings.png", height: 50, width: 50,),
                    SizedBox(
                      height: 5,
                    ),
                    Text(
          ...
          TimelineTile(
            ...
            rightChild: GestureDetector(
              child: Container(
                child: Column(
                  children: [
                    Image.asset("assets/TimeLine_Images/Thesis.png", height: 50, width: 50,),
                    SizedBox(
                      height: 5,
                    ),
                    Text(
              ...
              onTap: () {
                return showDialog(
                  ...
                  builder: (ctx) => AlertDialog(
                    backgroundColor: BackGround_Colour,
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(15))),
                    title: Text("Final Thesis Submission", textAlign: TextAlign.center),
                    content: Text("Details for the Procedure"),
                    actions: <Widget>[
                      FlatButton(
                        onPressed: () {
          ...
          TimelineTile(
            ...
            leftChild: GestureDetector(
              child: Container(
                child: Column(
                  children: [
                    Image.asset("assets/TimeLine_Images/External_presentation.png", height: 50, width: 50,),
                    SizedBox(
                      height: 5,
                    ),
                    Text(
              ...
              onTap: () {
                return showDialog(
                  ...
                  builder: (ctx) => AlertDialog(
                    backgroundColor: BackGround_Colour,
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(15))),
                    title: Text("External Presentation", textAlign: TextAlign.center),
                    content: Text("Details for the Procedure"),
                    actions: <Widget>[
                      FlatButton(
                        onPressed: () {
